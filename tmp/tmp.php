...
---------------------------------------------------
        try {
            ...
            // $res =  D('MsgGateWay', 'Service')->msgSend(15029911786, 20, array('order_number'=>'10001'));
        } catch (\Exception $e) {
            $data = array(
                'code' => $e->getCode(),
                'msg' => $e->getMessage(),
        ...
        // $sms_log['sms_type'] = $data['type'];
        // $sms_log['sms_val_list'] = json_encode($params);
        // $this->add_sms_log($sms_log);
